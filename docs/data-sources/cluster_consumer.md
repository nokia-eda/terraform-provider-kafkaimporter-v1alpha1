...
page_title: "kafkaimporter-v1alpha1_cluster_consumer Data Source - kafkaimporter-v1alpha1"
subcategory: ""
description: |-
  
---

# kafkaimporter-v1alpha1_cluster_consumer (Data Source)
...
- `name` (String) name of the ClusterConsumer

### Optional

- `hash` (String) resource content will be returned as it was at the time of this git hash
- `spec` (Attributes) ClusterConsumerSpec defines the desired state of ClusterConsumer (see [below for nested schema](#nestedatt--spec))
...
- `status` (Attributes) ClusterConsumerStatus defines the observed state of ClusterConsumer. (see [below for nested schema](#nestedatt--status))
