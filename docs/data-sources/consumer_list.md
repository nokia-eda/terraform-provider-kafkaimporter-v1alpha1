...
page_title: "kafkaimporter-v1alpha1_consumer_list Data Source - kafkaimporter-v1alpha1"
subcategory: ""
description: |-
  
---

# kafkaimporter-v1alpha1_consumer_list (Data Source)
...
- `spec` (Attributes) Spec defines the desired state of the Consumer (see [below for nested schema](#nestedatt--items--spec))
...
- `status` (Attributes) Status defines the observed state of the Consumer (see [below for nested schema](#nestedatt--items--status))
