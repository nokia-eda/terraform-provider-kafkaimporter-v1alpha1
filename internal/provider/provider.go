...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-kafkaimporter/internal/eda/utils"
...
var _ provider.Provider = (*kafkaimporterProvider)(nil)

func New(ver string) func() provider.Provider {
	return func() provider.Provider {
		return &kafkaimporterProvider{version: ver}
	}
}

type kafkaimporterProvider struct {
	version string
}
...
func (p *kafkaimporterProvider) Schema(ctx context.Context, req provider.SchemaRequest, resp *provider.SchemaResponse) {
...
func (p *kafkaimporterProvider) Configure(ctx context.Context, req provider.ConfigureRequest, resp *provider.ConfigureResponse) {
...
func (p *kafkaimporterProvider) Metadata(ctx context.Context, req provider.MetadataRequest, resp *provider.MetadataResponse) {
	resp.TypeName = "kafkaimporter-v1alpha1"
	resp.Version = p.version
}

func (p *kafkaimporterProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAppGroupDataSource,
		NewClusterConsumerDataSource,
		NewClusterConsumerListDataSource,
		NewConsumerDataSource,
		NewConsumerListDataSource,
		NewResourceListDataSource,
	}
}

func (p *kafkaimporterProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewClusterConsumerResource,
		NewConsumerResource,
	}
}
