...
import (
	...
	"github.com/nokia/eda/apps/terraform-provider-kafkaimporter/internal/resource_consumer"
	"github.com/nokia/eda/apps/terraform-provider-kafkaimporter/internal/tfutils"
)

const (
	create_rs_consumer = "/apps/kafkaimporter.eda.nokia.com/v1alpha1/namespaces/{namespace}/consumers"
	read_rs_consumer   = "/apps/kafkaimporter.eda.nokia.com/v1alpha1/namespaces/{namespace}/consumers/{name}"
	update_rs_consumer = "/apps/kafkaimporter.eda.nokia.com/v1alpha1/namespaces/{namespace}/consumers/{name}"
	delete_rs_consumer = "/apps/kafkaimporter.eda.nokia.com/v1alpha1/namespaces/{namespace}/consumers/{name}"
)

var (
	_ resource.Resource                = (*consumerResource)(nil)
	_ resource.ResourceWithConfigure   = (*consumerResource)(nil)
	_ resource.ResourceWithImportState = (*consumerResource)(nil)
)
...
func (r *consumerResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	err = r.client.Create(ctx, create_rs_consumer, map[string]string{
	...
	err = r.client.Get(ctx, read_rs_consumer, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)

	tflog.Info(ctx, "Read()::API returned", map[string]any{
		"path":      read_rs_consumer,
		"result":    spew.Sdump(result),
		"timeTaken": time.Since(t0).String(),
	})
...
func (r *consumerResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	err = r.client.Update(ctx, update_rs_consumer, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, reqBody, &result)
...
func (r *consumerResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	err := r.client.Delete(ctx, delete_rs_consumer, map[string]string{
		"namespace": tfutils.StringValue(data.Metadata.Namespace),
		"name":      tfutils.StringValue(data.Metadata.Name),
	}, &result)
