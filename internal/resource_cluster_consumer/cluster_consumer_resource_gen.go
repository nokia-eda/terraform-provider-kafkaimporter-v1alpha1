...
package resource_cluster_consumer
...
func ClusterConsumerResourceSchema(ctx context.Context) schema.Schema {
		...
		Attributes: map[string]schema.Attribute{
			...
			"api_version": schema.StringAttribute{
				...
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^kafkaimporter\\.eda\\.nokia\\.com/v1alpha1$"), ""),
				},
				Default: stringdefault.StaticString("kafkaimporter.eda.nokia.com/v1alpha1"),
			},
			...
			"kind": schema.StringAttribute{
				...
				Computed: true,
				Validators: []validator.String{
					stringvalidator.RegexMatches(regexp.MustCompile("^ClusterConsumer$"), ""),
				},
				Default: stringdefault.StaticString("ClusterConsumer"),
			},
			...
			"name": schema.StringAttribute{
				Optional:            true,
				Computed:            true,
				Description:         "name of the ClusterConsumer",
				MarkdownDescription: "name of the ClusterConsumer",
			},
			"spec": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					...
					"delivery_mode": schema.StringAttribute{
						...
						Default: stringdefault.StaticString("AtLeastOnce"),
					},
					...
					"path": schema.StringAttribute{
						Required:            true,
						Description:         "Go template for where to publish the message\ndefaults to {{ index .msg \"path\" }}",
						MarkdownDescription: "Go template for where to publish the message\ndefaults to {{ index .msg \"path\" }}",
					},
				...
				Required:            true,
				Description:         "ClusterConsumerSpec defines the desired state of ClusterConsumer",
				MarkdownDescription: "ClusterConsumerSpec defines the desired state of ClusterConsumer",
			},
			"status": schema.SingleNestedAttribute{
				...
				Optional:            true,
				Computed:            true,
				Description:         "ClusterConsumerStatus defines the observed state of ClusterConsumer.",
				MarkdownDescription: "ClusterConsumerStatus defines the observed state of ClusterConsumer.",
			},
		},
	}
}

type ClusterConsumerModel struct {
