# terraform-provider-kafkaimporter-v1alpha1

terraform-provider-kafkaimporter-v1alpha1 is a terraform provider plugin for the `kafkaimporter` resource in Nokia EDA.
